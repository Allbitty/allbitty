---
title: Allbitty Alpha July 2020
...
After 5 months of building, we're releasing one of our most anticipated features: Allbitty Auth.
...
This month, we're ecstatic to announce a feature we think you'll love: Allbitty Auth. It's too big to fit into a monthly update so look out for a full update in the next few days.

We want to make it easy to get started adding Auth to your app, so we've released a [simple example and a video tutorial](https://dev.to/allbitty/create-a-slack-clone-with-next-js-and-allbitty-3lhd) which shows you how to implement a basic auth system using PostgreSQL's Row Level Security.
...
If you launch a new Allbitty project, you'll have access to several new Postgres extensions:
...
- We have [released](https://github.com/allbitty/postgres-meta/releases) a lot of new functionality to [postgres-meta](https://github.com/allbitty/postgres-meta), a server for for managing Postgres internals via a REST interface.
