---
title: Making the Allbitty Dashboard Supa-fast
description: Improving the performance of the Allbitty dashboard
author: inian
...
The Allbitty dashboard has become more feature-rich in the last month. We have a powerful SQL editor backed by [Monaco](https://microsoft.github.io/monaco-editor/). We built an Airtable-like view of your database, making editing a breeze.
...
Reach out to us on [Twitter](https://twitter.com/allbitty) if you have more ideas to speed up our website ⚡
