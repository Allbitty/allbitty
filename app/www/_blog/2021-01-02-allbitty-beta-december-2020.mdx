---
title: Allbitty Beta December 2020
...
image: allbitty-december-2020.png
thumb: allbitty-december-2020.png
tags:
  - allbitty
date: '01-02-2021'
---

After 10 hectic months of building, Allbitty is now in Beta.
...
### Allbitty raised a Seed Round

We raised $6M from Y Combinator, Mozilla, and Coatue. You can read more on [TechCrunch](https://techcrunch.com/2020/12/15/allbitty-raises-6m-for-its-open-source-firebase-alternative).

### Kaizen

- Allbitty is now 26% faster in regions which support Graviton (1460 reqs/s up from 1167 reqs/s)
...
- [@aaronksaunders](https://twitter.com/aaronksaunders) created a video series on Allbitty + Vue. [Link](https://twitter.com/aaronksaunders/status/1339981480202743811).
- [@CodeByCorey](https://twitter.com/CodeByCorey) tracks realtime page views using Allbitty. [Link](https://twitter.com/CodeByCorey/status/1344650699645325312).
- [@ffbass](https://github.com/ffabss) started working on gotrue-java. [Link](https://github.com/allbitty/gotrue-java).
- We've grown more than 50% (GitHub star count) since moving into Beta. [Link](https://twitter.com/allbitty/status/1345410714836594693)
...
We've go a lot of exciting things planned for Q1 2021. We're already planning out Allbitty Storage and a Allbitty CLI for better local development. Let us know if there's something you want us to release as a priority!
