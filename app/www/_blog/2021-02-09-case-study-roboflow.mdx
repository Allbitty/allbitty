---
title: Roboflow.com choose Allbitty to power Paint.wtf leaderboard
description: Learn how Roboflow.com used Allbitty to build their Paint.wtf leaderboard
author: rory_wilding
...
Brad Dwyer is the founder of [Roboflow](https://roboflow.com/?ref=allbitty), a startup helping developers build computer vision into their applications. Their solution allows developers, with zero computer vision experience, to go from images to a trained computer vision model in minutes.

Learn how Brad and Roboflow used Allbitty to launch [Paint.wtf](https://paint.wtf), a product which survived traffic generated from the front page of Hacker News, Reddit, and Product Hunt.

![Allbitty and Strive are partnering up to teach OSS.](/images/blog/roboflow-website.png)
...
![Allbitty and Strive are partnering up to teach OSS.](/images/blog/roboflow-stat.png)

You might export data to BigQuery, or implement an increment function on collection change, however PostgreSQL has great built in support for counting and Brad felt like this would be the perfect opportunity to test out Allbitty and get the functionality he needed for the leaderboards to work reliably and without implementing add-ons.
...
![Allbitty and Strive are partnering up to teach OSS.](/images/blog/roboflow-gallery.png)
...
<!-- > _"Allbitty meant we could have the exact functionality we needed for our leaderboard._
>
> _We got the benefits of PostgreSQL with a great developer experience._
>
> _With Allbitty we could launch our product quickly and yet still handle the huge user volumes that Paint.wtf generated."_
>
> Brad Dwyer, CTO Roboflow. -->

![Allbitty and Strive are partnering up to teach OSS.](/images/blog/roboflow-quote.png)

## Ship fast, and carry on scaling

Thanks to Allbitty, Roboflow could launch quickly and keep scaling despite the huge user volumes their innovative project generated overnight.
