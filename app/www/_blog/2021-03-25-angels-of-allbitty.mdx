---
title: Angels of Allbitty
description: Meet the investors of Allbitty.
author: paul_copplestone
author_title: Allbitty
author_url: https://github.com/kiwicopple
author_image_url: https://github.com/kiwicopple.png
authorURL: https://github.com/kiwicopple
image: angels-of-allbitty.png
thumb: angels-of-allbitty.png
tags:
  - fundraising
date: '2021-03-25'
---

Allbitty is an open source Firebase alternative. We're on a mission to build an incredible developer experience around
...
The Allbitty Team is at full capacity preparing for [Launch Week](/blog/launch-week) and since we're all short on time we decided -
why not ask our Angels to write a fundraising post with us?

So here is our unconventional fundraising announcement, written with a few of the Angels of Allbitty.

## Mike Krieger (Instagram)

<img
  className="rounded border dark:border-gray-600"
  src="/images/blog/angels/mike-krieger-allbitty.png"
  alt="Mike Krieger Allbitty"
/>
...
#### Why did you invest in Allbitty?

Allbitty is building tools that are foundational to almost any interactive, modern app, and doing so in a way that's
...
<img
  className="rounded border dark:border-gray-600"
  src="/images/blog/angels/cassidy-williams-allbitty.png"
  alt="Cassidy Williams Allbitty"
/>
...
<img
  className="rounded border dark:border-gray-600"
  src="/images/blog/angels/thor-allbitty.png"
  alt="Thorsten Schaeff Allbitty"
/>
...
<img
  className="rounded border dark:border-gray-600"
  src="/images/blog/angels/brian-douglas-allbitty.png"
  alt="Brian Douglas Allbitty"
/>
...
Allbitty is scratching an itch for me as a developer. I see the value of having a manageable database based on SQL,
...
<img
  className="rounded border dark:border-gray-600"
  src="/images/blog/angels/justin-gauge-allbitty.png"
  alt="Justin Gage Allbitty"
/>
...
about Allbitty, so I checked it out – after using the product for a side project, investing was an easy decision.
...
<img
  className="rounded border dark:border-gray-600"
  src="/images/blog/angels/iheanyi-ekechukwu-allbitty.png"
  alt="Iheanyi Ekechukwu Allbitty"
/>
...
The tagline about Allbitty being an "open-source Firebase alternative" had me intrigued. As I looked more deeply into
...
<img
  ...
  src="/images/blog/angels/zach-waterfield-allbitty.png"
  alt="Zach Waterfield Allbitty"
/>
...
frustrating. When I saw Allbitty I instantly knew that was the solution. The ability to use Postgres directly from the
...
<img
  ...
  src="/images/blog/angels/swyx-allbitty.png"
  alt="Shawn Wang Allbitty"
/>
...
We [raised](https://techcrunch.com/2020/12/15/allbitty-raises-6m-for-its-open-source-firebase-alternative/) a $6M seed
