---
title: Launch week
description: Five days of Allbitty.
author: ant_wilson
...
image: allbitty-launch-week.png
thumb: allbitty-launch-week.png
tags:
  - storage
  - pricing
  - developers
...
or follow us on twitter to keep up to date: [@allbitty](https://twitter.com/allbitty) and follow the hashtag [#supalaunchweek](https://twitter.com/hashtag/supalaunchweek).
...
If you aren’t confident in our business model though, we’re open source. You can [host it yourself](https://github.com/allbitty/allbitty/tree/master/docker). Even better, everything we build is centered around Postgres, so you can pretty much `pgdump` your database and take it to your favorite Postgres platform.

![Allbitty Pricing](/images/blog/launch-week/bernie-1.png)

## Tuesday: Storage

- 30 March 2021

Checkout the launch post here: [Allbitty Storage](/blog/allbitty-storage)

As with anything that we build in Allbitty, Storage is fast, secure and scalable. It's integrated well with the rest of the Allbitty ecosystem.
...
![Allbitty Storage](/images/blog/launch-week/bernie-2.png)
...
Today we launched the Allbitty CLI which includes:

- Running Allbitty locally
- Managing database migrations
- Self hosting with Docker!

Check out the announcement post here: [/blog/allbitty-cli](/blog/allbitty-cli)

![Allbitty CLI](/images/blog/launch-week/bernie-3.png)
...
And now we're doing what we do best at Allbitty and making it open source, so that the community can benefit from the UI work done at Allbitty, and vice versa. The open source community is an invaluable asset to the work we do every day, and it's genuinely the main driver which enables our relatively small team to work fast and ship often.

Check out the demo and documentation website directly here: [ui.allbitty.com](https://ui.allbitty.com/)

![Allbitty UI](/images/blog/launch-week/bernie-4.png)

## Friday: One more thing

- 2 April 2021

It's the season finale of Allbitty Launchweek! And we have THREE more things to share:

1. [Connection Pooling with PgBouncer](/blog/allbitty-pgbouncer) - now you can connect directly to your Postgres instance without needing to worry that you'll cap out on connections. Perfect for use with Prisma.

2. [Workflow Engine](/blog/allbitty-workflows) - Our WIP states language will eventually enable a drag and drop workflow builder like Zapier inside the dashboard. Built with Elixir for scale!

3. allbitty.io is now allbitty.com - check out our origin story here: [/blog/allbitty-dot-com](/blog/allbitty-dot-com)
