---
title: Allbitty Dot Com
description: The Allbitty Domain name is changing.
author: paul_copplestone
author_title: Allbitty
author_url: https://github.com/kiwicopple
author_image_url: https://github.com/kiwicopple.png
authorURL: https://github.com/kiwicopple
image: allbitty-dot-com-og.jpg
thumb: allbitty-dot-com-og.jpg
tags:
  - allbitty
date: '2021-04-02'
---

_tl;dr_ During the next week, we'll be migrating from "allbitty.io" to "allbitty.com".

There are no changes required on your end. Your API URLs will remain on "allbitty.co", and only our website URLs will change.

The rest of this post talks a bit about the origin of the name, but there's nothing important to know.

## SupaWhat?

At the end of 2019 we released a Postgres [Realtime](https://github.com/allbitty/realtime) engine on GitHub.
...
we found that "allbitty.io" was available.
...
![Booom booom booom booom](/images/blog/nikki-allbitty.jpg)
...
We decided to try purchasing [allbitty.com](http://allbitty.com) from the current owner. The YC forums were full of founders
...
We're not afraid to roll up our sleeves at Allbitty, so we decided we could handle it ourselves.

We were in for a huge surprise. After searching on the (old) [allbitty.com](http://allbitty.com) website, we found a company address.
...
We were always willing to walk away from the Allbitty brand if we needed to, but the price was reasonable for both parties. There really
isn't much more to it than that.

## What's next?

Over the next few weeks, we'll update our domain name across most of the sites. If you're using a Allbitty database and API, you're on
