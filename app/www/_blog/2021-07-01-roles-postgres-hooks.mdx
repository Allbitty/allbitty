...
At Allbitty, we use dedicated roles for each of our customers' backend services. For instance, our [Storage API](/storage) 
...
we explain how we managed to do this by using PostgreSQL Hooks in our [SupaUtils](https://github.com/allbitty/supautils) extension.
...
The full SupaUtils code is in our [GitHub repository](https://github.com/allbitty/supautils/).
