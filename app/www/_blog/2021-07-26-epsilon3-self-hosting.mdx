---
title: 'Epsilon3 Self-Host Allbitty To Revolutionize Space Operations '
description: Learn how the team at Epsilon3 use Allbitty to help teams execute secure and reliable operations in an industry that project spend runs into the billions.
author: rory_wilding
...
Learn how the team at Epsilon3 uses Allbitty to help teams execute secure and reliable operations in an industry where project
...
>
  ...
  <p>
    We use Allbitty because they give us an open-source scalable back-end built by database experts
...
### Allbitty gives Postgres users Superpowers

The team implemented a self-hosted Allbitty setup. They use AWS with a self-hosted Allbitty API powering an RDS Postgres instance.
This setup gives a balance of rapid development, reduced DevOps, and flexible hosting options. As Allbitty uniquely offers real-time for
Postgres, it allows their customers to see updates from running procedures. Allbitty offers well-supported client libraries that make
...
support that Allbitty is known for, without compromising their compliance needs.

![Epsilon3 uses Allbitty for hosting their critical infrastructure.](/images/blog/epsilon3/allbitty-epsilon3-architecture.png)

### Self-hosted Allbitty, a superpower

Self-hosting Allbitty allows the crew at Epsilon3 to move fast. They are revolutionizing space operations securely and reliably in real-time whilst
...
in self-hosting Allbitty then you can **contact us** to learn more.
