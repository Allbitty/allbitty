...
image: hackathon/og-allbitty-hackathon.png
thumb: hackathon/cover-allbitty-hackathon.png
tags:
  - launch-week
  - hackathon
date: '2021-07-30'
...
# The Allbitty Hackathon

We've reached the end of [Launch Week II: The SQL](/blog/2021/07/22/allbitty-launch-week-sql) - but it's the start of something else...

The first Allbitty Hackathon starts **right now**.

## Key Facts

- You have 7 days to build a new **Open Source** project using Allbitty
...
- You can win one of these extremely [Limited Edition Olympic Gold](https://store.allbitty.com/products/hackathon-prize) and Silver Allbitty T-Shirts
...
The Allbitty Team will be taking part in the Hackathon and you'll find us live building in our discord all week. We're temporarily adding two channels:
