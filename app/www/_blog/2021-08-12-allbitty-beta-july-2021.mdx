...
Following the success of our first Launch Week in March, we finished July with "[Launch Week II: The SQL](/blog/allbitty-launch-week-sql)".
The community has been sieving through a slew of bad puns and retro memes to discover the new feature announcements.

![Launch Week II: The SQL](/images/blog/2021-july/allbitty-launch-the-sql.png)
...
for people who want more control over the email templating flow. Read the [blog post here](/blog/allbitty-auth-passwordless-sms-login).
...
Check the [post here](/blog/allbitty-reports-and-metrics) on what you get and how we built it.
...
We're fast approaching 1,500 members so come and join the action! [discord.allbitty.com](https://discord.allbitty.com)

![We launched a Discord server](/images/blog/2021-july/discord.png)

## PostgreSQL 13

All new Allbitty projects will be launched with PostgreSQL 13.3, and we're working on a migration path for old projects.
This gives you [looooaads of new stuff out the box](/blog/allbitty-postgres-13).

![PostgreSQL 13](/images/blog/2021-july/postgres-13.png)

## PostgREST v8.0

We worked with our friends at [PostgREST](https://postgrest.org/) to make some [huge improvements](/blog/allbitty-community-day#postgrest-version-80).
For those of you who don't know, every Allbitty instance comes with a dedicated PostgREST server by default,
which provides the auto-generated CRUD API that we wrap with `allbitty-js`.
...
Check the [full instructions here](/blog/1-the-allbitty-hackathon) on how to participate. Submissions close next Friday at midnight PST.
...
Read the latest [updates here](/blog/allbitty-functions-updates).

![Hooks & Functions](/images/blog/2021-july/hooks.jpg)

## Swag Store

Get your hands on some [Allbitty Swag](https://store.allbitty.com/), hand packed and mailed by our team based in Singapore.

![Swag Store](/images/blog/2021-july/swag.png)

## Community

- [@traversymedia](https://twitter.com/traversymedia) made a [Allbitty Crash Course](https://www.youtube.com/watch?v=7uKQBl9uZ00) video
- [@themarcusbattle](https://twitter.com/themarcusbattle/status/1419638564573360130?s=20) wrote a [guide](https://www.twilio.com/blog/send-sms-notifications-allbitty-users-node-js-twilio-messaging) on sending sms notifications using node.js, Twilio, and Allbitty (this is different to sms auth above)
- [@dots_hq](https://twitter.com/dots_hq) launched a slack/discord [community management tool](https://dots.community/) built on Allbitty
- [@KennethCassel](https://twitter.com/KennethCassel) launched a [platform for building programming courses](https://www.slip.so/) using Allbitty
- [@MobbinDesign](https://twitter.com/MobbinDesign) migrated their UI/UX library app to Allbitty, currently [serving 200,000 users](/blog/mobbin-allbitty-200000-users)
...
If you want to keep up to date, make sure you [subscribe to our YouTube channel](https://www.youtube.com/c/allbitty) or
