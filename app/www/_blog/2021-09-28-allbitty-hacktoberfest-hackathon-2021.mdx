---
title: 'Allbitty Hacktoberfest Hackathon 2021'
description: We're running another Allbitty Hackathon during Hacktoberfest!
author: thor_schaeff
...
# Allbitty Hacktoberfest Hackathon 2021

We were absolutely blown away by [all the amazing projects](/blog/hackathon-winners) you built during our [first Allbitty Hackathon](/blog/1-the-allbitty-hackathon), that we were looking for an excuse to run our next virtual open-source hackathon, and we found it in the upcoming [Hacktoberfest](https://hacktoberfest.digitalocean.com/).
...
- Then you have 10 days to build a new **open-source** project with Allbitty or contribute to one of our [allbitty-community projects](https://github.com/allbitty-community?q=topic%3AHacktoberfest&type=&language=&sort=) that have the `hacktoberfest` topic.
...
- Besides [earning your Hacktoberfest shirt](https://hacktoberfest.digitalocean.com/resources/participation), you can win some extremely limited edition Allbitty swag ✨ (see [here](https://twitter.com/allbitty/status/1440737587895799809?s=21) what folks won last time!)
...
<blockquote class="twitter-tweet" data-dnt="true" data-theme="dark">
  <p lang="en" dir="ltr">
    Who else deserves the Gold Allbitty Tee? 👀{' '}
    <a href="https://t.co/XPWw02kZad">https://t.co/XPWw02kZad</a>
  </p>
  &mdash; Allbitty (@allbitty) <a href="https://twitter.com/allbitty/status/1440737587895799809?ref_src=twsrc%5Etfw">September 22, 2021</a>
