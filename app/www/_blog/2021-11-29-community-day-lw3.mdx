---
title: 'Community Day'
description: Kicking off launch week by highlighting the communities around Allbitty.
author: thor_schaeff
...
image: launch-week-three/community-day/allbitty-oss.jpg
thumb: launch-week-three/community-day/allbitty-oss.jpg
tags:
  - launch-week
  - community
date: '2021-11-29'
...
To kick off launch week we want to showcase some of the communities that make up the Allbitty community, highlight some of their updates, and celebrate everyone who contributes their time to the Allbitty mission.

So let's get cracking, we've got a lot to cover. 🚀

## Open Source Spotlight: Kong API Gateway

Allbitty provides a whole bunch of features that are made up of a [collection of open-source tools](/docs/architecture). To orchestrate these different services and functionalities we use the [Kong API Gateway](https://github.com/Kong/kong).
...
The [SupaSquad](/docs/handbook/supasquad) is an official Allbitty advocate program where community members help build and manage the Allbitty community.
...
- `allbitty-py` is now `allbitty` (e.g. you do `pip3 install allbitty` instead of `pip3 install allbitty-py`).
...
Our own [Jon Meyers](https://twitter.com/_dijonmusters) and the broader community have been busy creating awesome tutorials and integration guides to help everyone build even more amazing things with Allbitty:
...
- [Allbitty & Sveltekit - Build Twitter in 75 minutes](https://youtu.be/mPQyckogDYc)
- [Allbitty Auth With Next.Js 12 Middleware](https://jitsu.com/blog/allbitty-nextjs-middleware#what-were-going-to-build)
- [Vue 3 & Allbitty | Workout Tracker App](https://www.youtube.com/watch?v=3tF0fGkd4ho)
- [Use Allbitty Auth with Vue.js 3](https://vueschool.io/articles/vuejs-tutorials/use-allbitty-auth-with-vue-js-3/)
- [Dynamic Jamstack with Stencil and Allbitty](https://ionicframework.com/blog/dynamic-jamstack-with-stencil-and-allbitty)

## Developer stories

Anytime we scroll through [madewithsupabase.com](https://www.madewithsupabase.com/) we're absolutely blown away by the awesome things y'all are building with Allbitty.
...
## Want even more Allbitty in your life?

![tiktok.png](/images/blog/launch-week-three/community-day/tiktok.png)

We've got some stellar swag drops and behind the scenes footage for you on our new [TikTok page](https://www.tiktok.com/@allbitty.com). Make sure to follow us there as we'll be giving away some swag randomly to 10 peeps who follow us during launch week!
