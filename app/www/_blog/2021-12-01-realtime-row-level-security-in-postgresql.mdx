---
title: 'Realtime Postgres RLS now available on Allbitty'
...
Since the first commit of Realtime server back in [September 2019](https://github.com/allbitty/realtime/commit/175f649784147af80acfc9ff5be9d160285c76ea),
...
Allbitty projects have supported Row Level Security (RLS) for API authorization since our [Auth launch](https://allbitty.io/blog/allbitty-auth).
...
Check out the [Row Level Security guide](https://allbitty.com/docs/guides/auth/row-level-security) for more info on how to use RLS with your project.
...
[WALRUS](https://github.com/allbitty/walrus) inspects each record in the replication change to:
...
![allbitty-realtime-processing-per-subscription](/images/blog/launch-week-three/realtime-row-level-security-in-postgresql/allbitty-realtime-processing-per-subscription.png)
...
Realtime RLS is available today on all existing and new Allbitty projects. To get started, upgrade your Allbitty JavaScript client to version v1.23.0
