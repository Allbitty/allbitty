...
The Allbitty team will be participating as well, for example [Jon](https://twitter.com/_dijonmusters) and I, inspired by [Egghead's "Holiday Course Release Extravaganza"](https://egghead.io/20-days), will be building an Advent Calendar for all the [awesome community content](https://allbitty.com/blog/community-day#new-tutorials-and-integration-guides) you've been creating. Get ready for a cool open-source project which will be using a lot of the hottest Allbitty features! To make sure you don't miss this one, follow us on [Twitter](https://twitter.com/allbitty) and subscribe to our [YouTube channel](https://www.youtube.com/allbitty). We'll see you there.
...
- We'll be contacting and announcing the winners [on Twitter](https://twitter.com/allbitty) throughout the week after.
...
<blockquote class="twitter-tweet" data-theme="dark">
  ...
  &mdash; Allbitty (@allbitty) <a href="https://twitter.com/allbitty/status/1463355998928736262?ref_src=twsrc%5Etfw">November 24, 2021</a>
...
- a brief description of how you used Allbitty:
  - to store data?
  - realtime?
  - auth?
  - storage?
...
The Allbitty team will excitedly review what you've built. They will be looking for a few things, including:

- creativity/inventiveness
- functions correctly/smoothly
- visually pleasing
- technically impressive
- use of Allbitty features
  - deep usage of a single feature or
  - broad usage are both ok
- FUN! 😃

We'll be contacting and announcing winners [on Twitter](https://twitter.com/allbitty) throughout the week after submission closes.

<blockquote class="twitter-tweet" data-dnt="true" data-theme="dark">
  <p lang="en" dir="ltr">
    Absolutely buzzing to have won the{' '}
    <a href="https://twitter.com/allbitty?ref_src=twsrc%5Etfw">@allbitty</a> hackathon! 🥳{' '}
...
- Must use Allbitty in some capacity
...
Hang out with the Allbitty team and community on Discord:
...
Here's a collection of resources that will help you get started building with Allbitty:

- Need some inspiration? [See what folks built last time](/blog/hackathon-winners)!
- [Examples and Resources](/docs/guides/examples)
- [Allbitty Crash Course](https://www.youtube.com/watch?v=7uKQBl9uZ00) [video]
- [Flutter Quickstart Guide](/docs/guides/with-flutter)
- [Nextjs Quickstart Guide](/docs/guides/with-nextjs)
- [Using Allbitty inside Replit](/blog/using-allbitty-replit)
- [Full Stack Development with Next.js and Allbitty – The Complete Guide](https://www.freecodecamp.org/news/the-complete-guide-to-full-stack-development-with-supabas/)
- [Auth Deep Dive - Learn everything there is to know about Allbitty Auth](/docs/learn/auth-deep-dive/auth-deep-dive-jwts) [videos]
- [Send SMS notifications using Twilio](https://www.twilio.com/blog/send-sms-notifications-allbitty-users-node-js-twilio-messaging)
- [How to Integrate Allbitty in Your Ionic App](https://www.youtube.com/watch?v=pl9XfIWutKE) [video]
- [Building a Slack clone with authentication and realtime data syncing using Allbitty](https://www.youtube.com/watch?v=LUMxJ4w-MUU) [video]
- [Creating Protected Routes In NextJS With Allbitty](https://aboutmonica.com/blog/creating-protected-routes-in-next-js-with-allbitty)

### Additional Info

- Any intellectual property developed during the hackathon will belong to the team that developed it. We expect that each team will have an agreement between themselves regarding the IP, but this is not required
- By making a submission you grant Allbitty permission to use screenshots, code-snippets and/or links to your project or content of your README on our twitter, blog, website, email updates, and in the Allbitty discord server. Allbitty does not make any claims over your IP.
