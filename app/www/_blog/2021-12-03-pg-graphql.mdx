...
description: GraphQL support is in development for PostgreSQL + Allbitty.
author: oli_rice
author_url: https://github.com/olirice
author_image_url: https://github.com/olirice.png
authorURL: https://github.com/olirice
image: launch-week-three/five-more-things/allbitty-pg-graphql-og.png
thumb: launch-week-three/five-more-things/allbitty-pg-graphql-thumb.png
tags:
  - launch-week
  - community
  - graphql
...
Interested? You're [3 commands away](https://allbitty.github.io/pg_graphql/quickstart/) from a live [GraphiQL](https://graphql-dotnet.github.io/docs/getting-started/graphiql/) demo.


## Motivation

The Allbitty stack is centered around PostgreSQL as the single source of truth. All data, configuration, and security are housed in the database so any GraphQL solution needed to be equivalently SQL-centric.
...
For that reason, we decided to invest in a lightweight alternative that runs in the database, and can be exposed over HTTP using the existing [PostgREST](https://allbitty.com/docs/guides/api) deployments' [RPC functionality.](https://postgrest.org/en/v8.0/api.html#stored-procedures)
...
For a more complete examples with relationships, enums, and more exotic types check out the [reflection doc](https://allbitty.github.io/pg_graphql/reflection).
...
Full steps to reproduce this output are available in [the docs](https://allbitty.github.io/pg_graphql).

## Open Source

`pg_graphql` is [open source software](https://github.com/allbitty/pg_graphql/). As always, Issues and PRs are welcome.


[Try `pg_graphql`](https://allbitty.github.io/pg_graphql/quickstart/) today to see a live [GraphiQL](https://graphql-dotnet.github.io/docs/getting-started/graphiql/) demo.
