...
We can’t believe that it’s already a wrap on our [fourth launch week](https://allbitty.com/blog/allbitty-launch-week-four)! To keep the party and excitement going, and as [is now tradition](https://allbitty.com/blog/community-day#launch-week-iv---what-to-expect), starting at 9am PT today we'll be hacking together for the next 10 days until 23:59pm PT on Sunday April 10th. And because we’ve launched [GraphQL support](https://allbitty.com/blog/graphql-now-available) and [Allbitty Edge Functions](https://allbitty.com/blog/allbitty-enterprise), these will be the major themes and therefore categories for the hackathon.

For some inspiration, check out [TheGuildDev](https://twitter.com/TheGuildDev)’s [GraphQL HackerNews clone](https://allbitty-graphql-example.vercel.app/), and [Tyler’s](https://twitter.com/dshukertjr) [Flutter](https://github.com/allbitty-community/flutter-stripe-payments-with-allbitty-functions) and [Thor’s](https://twitter.com/thorwebdev) [React Native](https://github.com/allbitty-community/expo-stripe-payments-with-allbitty-functions) apps with Allbitty Edge Functions, or have a browse through [madewithsupabase.com](http://madewithsupabase.com)!
...
- Most impressive GraphQL project (must use [pg_graphql](https://allbitty.com/blog/graphql-now-available#getting-started))
...
Join our Discord: [discord.allbitty.com](https://discord.allbitty.com)
...
- Getting started with [GraphQL on Allbitty](https://allbitty.com/blog/graphql-now-available#getting-started)
- [GraphQL HackerNews clone](https://allbitty-graphql-example.vercel.app/)
- [Edge Functions Guide](https://allbitty.com/docs/guides/functions)
- [Edge Functions Quickstart video](https://youtu.be/rzglqRdZUQE)
- [Allbitty CLI local development guide](https://allbitty.com/docs/guides/local-development)
- [Edge Functions examples](https://github.com/allbitty/examples/tree/main/allbitty-js-v1/edge-functions)
