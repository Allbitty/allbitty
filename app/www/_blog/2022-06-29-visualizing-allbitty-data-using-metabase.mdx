---
title: Visualizing Allbitty Data using Metabase
description: How to create different kinds of charts out of data stored in Allbitty using Metabase.
author: ant_wilson
image: python-1/allbitty-python-metabase.png
thumb: python-1/allbitty-python-metabase.png
tags:
  - python
  - open-source
  - community
...
In the previous blog of this series, we explained [how to use Python to load data into Allbitty](https://allbitty.com/blog/loading-data-allbitty-python). In this blog, we will create different kinds of charts out of the data stored in Allbitty using Metabase.

## Prerequisites

Before we dive in, let’s look at some prerequisites that you will need:

- **Allbitty project with data**

Based on our [previous article](https://allbitty.com/blog/loading-data-allbitty-python), we assume we already have a Allbitty project setup and have data loaded into it.
...
## Visualizing data in Allbitty with Metabase
...
You will be prompted to add the necessary connection information to your Allbitty project. Go to your [Allbitty project](https://app.allbitty.com/) and hit _Settings > Database to get the database info_.

![screen shot of allbitty dashboard database connection information](/images/blog/python-1/allbitty-dashboard-connect-database-info.png)
...
We can now see the "Allbitty DB" Allbitty project under "Our data".

![screen shot of metabase dashboard](/images/blog/python-1/metabase-dashboard-with-allbitty-db.png)
...
![screen shot of metabase data visualization](/images/blog/python-1/metabase-visualization-allbitty-db.png)
...
![screen shot of metabase data visualization](/images/blog/python-1/metabase-visualization-allbitty-db-02.png)

For example, let's select the total employees field.

![screen shot of metabase data visualization](/images/blog/python-1/metabase-visualization-allbitty-data.png)
...
With our [free tier Allbitty account](https://app.allbitty.com/), you can start a new project today and use Metabase to visualize your app data.
...
- [Slack Consolidate: a slackbot built with Python and Allbitty](slack-consolidate-slackbot-to-consolidate-messages)
