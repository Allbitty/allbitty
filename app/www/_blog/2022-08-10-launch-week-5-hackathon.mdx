...
# The Allbitty Open Source Hackathon

Now is the perfect time to start your new Open Source project!

[Launch Week](https://allbitty.com/launch-week) is about to start and we're running a hackathon in parallel for the entire duration.

There's a $1500 GitHub sponsorship and [gold Allbitty caps](https://store.allbitty.com/products/gold-supacap) to be won!

[Allbitty-js v2.0](https://github.com/allbitty/allbitty-js/releases) and [Flutter SDK v1.0](https://allbitty.com/blog/allbitty-flutter-sdk-1-developer-preview) will both be announced during Launch Week, they are both available already and using them in your project will gain extra credit!

You can access the allbitty-js pre-release, including the new interface by running `npm install @allbitty/allbitty-js@rc`.
...
- You have 10 days to build a new **Open Source** project using Allbitty.
...
- There are 5 prize categories.
  ...
  - Most technically challenging, most fun, best flutter project, and most visually pleasing will all win a Gold Allbitty Cap!
...
The Allbitty Founders will be judging, we will be looking for:
...
The Allbitty Team will be taking part in the Hackathon and you'll find us live building in our discord all week. Please join us by building in public:
...
- [Day 1 - allbitty-js v2 Release Candidate](https://allbitty.com/blog/allbitty-js-v2)
