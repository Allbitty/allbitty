    ...
    [2117],
    {
     ...
     1284: function (e, t, r) {
         ...
         (n = (function (e) {
          ...
          return (
           !p &&
            ...
            ((p = s.match(/(Version)\/([\d.]+)/)) || (p = [0, 1, "13_0_0"]), (m = !1)),
      ...
      var p = {
       ...
       on: {
        init: function (e) {
         var t = (0, a.Jj)();
         e.params.resizeObserver && "undefined" !== typeof (0, a.Jj)().ResizeObserver
      ...
      var g = {
       updateSize: function () {
        var e,
         ...
         r = this,
         i = r.$el;
        (e = "undefined" !== typeof r.params.width && null !== r.params.width ? r.params.width : i[0].clientWidth),
         (t = "undefined" !== typeof r.params.height && null !== r.params.height ? r.params.height : i[0].clientHeight),
         (0 === e && r.isHorizontal()) ||
          (0 === t && r.isVertical()) ||
          ...
          Number.isNaN(e) && (e = 0),
          Number.isNaN(t) && (t = 0),
          (0, l.l7)(r, { width: e, height: t, size: r.isHorizontal() ? e : t }));
       },
       updateSlides: function () {
        ...
        if ("undefined" !== typeof s) {
         ...
         "string" === typeof y && y.indexOf("%") >= 0 && (y = (parseFloat(y.replace("%", "")) / 100) * s),
          ...
          i.slidesPerColumn > 1 &&
           ((C = Math.floor(p / i.slidesPerColumn) === p / e.params.slidesPerColumn ? p : Math.ceil(p / i.slidesPerColumn) * i.slidesPerColumn),
           "auto" !== i.slidesPerView && "row" === i.slidesPerColumnFill && (C = Math.max(C, i.slidesPerView * i.slidesPerColumn)));
         for (var M, P, k, O = i.slidesPerColumn, L = C / O, z = Math.floor(p / i.slidesPerColumn), _ = 0; _ < p; _ += 1) {
          x = 0;
          var A = c.eq(_);
          if (i.slidesPerColumn > 1) {
           ...
           if ("row" === i.slidesPerColumnFill && i.slidesPerGroup > 1) {
            var j = Math.floor(_ / (i.slidesPerGroup * i.slidesPerColumn)),
             G = _ - i.slidesPerColumn * i.slidesPerGroup * j,
             B = 0 === j ? i.slidesPerGroup : Math.min(Math.ceil((p - j * O * i.slidesPerGroup) / O), i.slidesPerGroup);
            (I = (N = G - (D = Math.floor(G / B)) * B + j * i.slidesPerGroup) + (D * C) / O), A.css({ "-webkit-box-ordinal-group": I, "-moz-box-ordinal-group": I, "-ms-flex-order": I, "-webkit-order": I, order: I });
           } else "column" === i.slidesPerColumnFill ? ((D = _ - (N = Math.floor(_ / O)) * O), (N > z || (N === z && D === O - 1)) && (D += 1) >= O && ((D = 0), (N += 1))) : (N = _ - (D = Math.floor(_ / L)) * L);
           A.css(t("margin-top"), 0 !== D ? i.spaceBetween && i.spaceBetween + "px" : "");
          }
          if ("none" !== A.css("display")) {
           if ("auto" === i.slidesPerView) {
            var R = getComputedStyle(A[0]),
             V = A[0].style.transform,
             H = A[0].style.webkitTransform;
            if ((V && (A[0].style.transform = "none"), H && (A[0].style.webkitTransform = "none"), i.roundLengths)) x = e.isHorizontal() ? A.outerWidth(!0) : A.outerHeight(!0);
            else {
             var F = r(R, "width"),
              W = r(R, "padding-left"),
              $ = r(R, "padding-right"),
             ...
             if (q && "border-box" === q) x = F + Y + X;
             else {
              var Z = A[0],
               J = Z.clientWidth;
              x = F + W + $ + Y + X + (Z.offsetWidth - J);
             }
            }
            V && (A[0].style.transform = V), H && (A[0].style.webkitTransform = H), i.roundLengths && (x = Math.floor(x));
           } else (x = (s - (i.slidesPerView - 1) * y) / i.slidesPerView), i.roundLengths && (x = Math.floor(x)), c[_] && (c[_].style[t("width")] = x + "px");
           c[_] && (c[_].swiperSlideSize = x),
            h.push(x),
            i.centeredSlides
             ? ((S = S + x / 2 + T / 2 + y), 0 === T && 0 !== _ && (S = S - s / 2 - y), 0 === _ && (S = S - s / 2 - y), Math.abs(S) < 0.001 && (S = 0), i.roundLengths && (S = Math.floor(S)), E % i.slidesPerGroup === 0 && f.push(S), v.push(S))
             : (i.roundLengths && (S = Math.floor(S)), (E - Math.min(e.params.slidesPerGroupSkip, E)) % e.params.slidesPerGroup === 0 && f.push(S), v.push(S), (S = S + x + y)),
            (e.virtualSize += x + y),
            (T = x),
            (E += 1);
          }
         }
         if (((e.virtualSize = Math.max(e.virtualSize, s) + g), a && o && ("slide" === i.effect || "coverflow" === i.effect) && n.css({ width: e.virtualSize + i.spaceBetween + "px" }), i.setWrapperSize))
          n.css((((P = {})[t("width")] = e.virtualSize + i.spaceBetween + "px"), P));
         if (i.slidesPerColumn > 1)
          if (((e.virtualSize = (x + i.spaceBetween) * C), (e.virtualSize = Math.ceil(e.virtualSize / i.slidesPerColumn) - i.spaceBetween), n.css((((k = {})[t("width")] = e.virtualSize + i.spaceBetween + "px"), k)), i.centeredSlides)) {
           M = [];
           for (var K = 0; K < f.length; K += 1) {
            var U = f[K];
            i.roundLengths && (U = Math.floor(U)), f[K] < e.virtualSize + f[0] && M.push(U);
           }
           f = M;
          }
         if (!i.centeredSlides) {
         ...
         (0, l.l7)(e, { slides: c, snapGrid: f, slidesGrid: v, slidesSizesGrid: h }),
          p !== u && e.emit("slidesLengthChange"),
          f.length !== w && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")),
       ...
       updateSlidesProgress: function (e) {
        ...
        if (0 !== i.length) {
         ...
         for (var a = 0; a < i.length; a += 1) {
          var l = i[a],
           d = (s + (r.centeredSlides ? t.minTranslate() : 0) - l.swiperSlideOffset) / (l.swiperSlideSize + r.spaceBetween);
          if (r.watchSlidesVisibility || (r.centeredSlides && r.autoHeight)) {
           var u = -(s - l.swiperSlideOffset),
            c = u + t.slidesSizesGrid[a];
           ((u >= 0 && u < t.size - 1) || (c > 1 && c <= t.size) || (u <= 0 && c >= t.size)) && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(a), i.eq(a).addClass(r.slideVisibleClass));
          }
          l.progress = n ? -d : d;
         }
       ...
       updateProgress: function (e) {
        ...
        var i = t.params,
         ...
         d = a,
         u = o;
        0 === n ? ((s = 0), (a = !0), (o = !0)) : ((a = (s = (e - t.minTranslate()) / n) <= 0), (o = s >= 1)),
       ...
       updateSlidesClasses: function () {
        ...
        i.loop && 0 === d.length && (d = r.eq(-1)).addClass(i.slidePrevClass),
         i.loop &&
       ...
       updateActiveIndex: function (e) {
        ...
        if ("undefined" === typeof c) {
         for (var p = 0; p < n.length; p += 1) "undefined" !== typeof n[p + 1] ? (i >= n[p] && i < n[p + 1] - (n[p + 1] - n[p]) / 2 ? (c = p) : i >= n[p] && i < n[p + 1] && (c = p + 1)) : i >= n[p] && (c = p);
        ...
        if ((t >= s.length && (t = s.length - 1), c !== o)) {
         ...
         (0, l.l7)(r, { snapIndex: t, realIndex: v, previousIndex: o, activeIndex: c }),
       ...
       updateClickedSlide: function (e) {
        var t,
         r = this,
         i = r.params,
         n = (0, o.Z)(e.target).closest("." + i.slideClass)[0],
         s = !1;
        if (n)
        ...
        (r.clickedSlide = n),
         r.virtual && r.params.virtual.enabled ? (r.clickedIndex = parseInt((0, o.Z)(n).attr("data-swiper-slide-index"), 10)) : (r.clickedIndex = t),
      ...
      var w = {
       ...
       setTranslate: function (e, t) {
        ...
        r.isHorizontal() ? (l = i ? -e : e) : (d = e),
         ...
         n.cssMode ? (a[r.isHorizontal() ? "scrollLeft" : "scrollTop"] = r.isHorizontal() ? -l : -d) : n.virtualTranslate || s.transform("translate3d(" + l + "px, " + d + "px, 0px)"),
       ...
       translateTo: function (e, t, r, i, n) {
        ...
        var l,
         d = s.minTranslate(),
         u = s.maxTranslate();
        if (((l = i && e > d ? d : i && e < u ? u : e), s.updateProgress(l), a.cssMode)) {
         var c,
          p = s.isHorizontal();
        ...
        return (
         0 === t
          ? (s.setTransition(0), s.setTranslate(l), r && (s.emit("beforeTransitionStart", t, n), s.emit("transitionEnd")))
          : (s.setTransition(t),
            s.setTranslate(l),
      ...
      var b = {
       slideTo: function (e, t, r, i, n) {
        ...
        g >= d.length && (g = d.length - 1), (p || l.initialSlide || 0) === (c || 0) && r && a.emit("beforeSlideChangeStart");
        var w,
         b = -d[g];
        if ((a.updateProgress(b), l.normalizeSlideIndex))
         for (var y = 0; y < u.length; y += 1) {
          ...
          "undefined" !== typeof u[y + 1] ? (S >= T && S < E - (E - T) / 2 ? (o = y) : S >= T && S < E && (o = y + 1)) : S >= T && (o = y);
         }
        ...
        if (((w = o > p ? "next" : o < p ? "prev" : "reset"), (f && -b === a.translate) || (!f && b === a.translate)))
         return a.updateActiveIndex(o), l.autoHeight && a.updateAutoHeight(), a.updateSlidesClasses(), "slide" !== l.effect && a.setTranslate(b), "reset" !== w && (a.transitionStart(r, w), a.transitionEnd(r, w)), !1;
        if (l.cssMode) {
         var C,
          x = a.isHorizontal(),
          M = -b;
         if ((f && (M = v.scrollWidth - v.offsetWidth - M), 0 === t)) v[x ? "scrollLeft" : "scrollTop"] = M;
         else if (v.scrollTo) v.scrollTo((((C = {})[x ? "left" : "top"] = M), (C.behavior = "smooth"), C));
         else v[x ? "scrollLeft" : "scrollTop"] = M;
         return !0;
        }
        return (
         0 === t
          ? (a.setTransition(0), a.setTranslate(b), a.updateActiveIndex(o), a.updateSlidesClasses(), a.emit("beforeTransitionStart", t, i), a.transitionStart(r, w), a.transitionEnd(r, w))
          : (a.setTransition(t),
            a.setTranslate(b),
            a.updateActiveIndex(o),
            a.updateSlidesClasses(),
            a.emit("beforeTransitionStart", t, i),
            a.transitionStart(r, w),
            a.animating ||
             ((a.animating = !0),
       ...
       slidePrev: function (e, t, r) {
        ...
        return (
         ...
         "undefined" !== typeof f && (u = o.indexOf(f)) < 0 && (u = i.activeIndex - 1),
         i.slideTo(u, e, t, r)
        );
       },
       ...
       slideToClosest: function (e, t, r, i) {
        ...
        if (l >= n.snapGrid[o]) {
         var d = n.snapGrid[o];
         l - d > (n.snapGrid[o + 1] - d) * i && (s += n.params.slidesPerGroup);
        } else {
         var u = n.snapGrid[o - 1];
         l - u <= (n.snapGrid[o] - u) * i && (s -= n.params.slidesPerGroup);
        }
       ...
       slideToClickedSlide: function () {
        ...
        if (r.loop) {
         ...
         (e = parseInt((0, o.Z)(t.clickedSlide).attr("data-swiper-slide-index"), 10)),
          r.centeredSlides
       ...
       loopCreate: function () {
        ...
        if (r.loopFillGroupWithBlank) {
         ...
         if (s !== r.slidesPerGroup) {
          for (var l = 0; l < s; l += 1) {
           var d = (0, o.Z)(t.createElement("div")).addClass(r.slideClass + " " + r.slideBlankClass);
           i.append(d);
          }
        ...
        n.each(function (t, r) {
         var i = (0, o.Z)(t);
         r < e.loopedSlides && c.push(t), r < n.length && r >= n.length - e.loopedSlides && u.push(t), i.attr("data-swiper-slide-index", r);
        });
        for (var p = 0; p < c.length; p += 1) i.append((0, o.Z)(c[p].cloneNode(!0)).addClass(r.slideDuplicateClass));
        for (var f = u.length - 1; f >= 0; f -= 1) i.prepend((0, o.Z)(u[f].cloneNode(!0)).addClass(r.slideDuplicateClass));
       },
       loopFix: function () {
        var e = this;
        ...
        if (r < n) (t = i.length - 3 * n + r), (t += n), e.slideTo(t, 0, !1, !0) && 0 !== d && e.setTranslate((l ? -e.translate : e.translate) - d);
        else if (r >= i.length - n) {
         (t = -i.length + r + n), (t += n), e.slideTo(t, 0, !1, !0) && 0 !== d && e.setTranslate((l ? -e.translate : e.translate) - d);
        }
      ...
      function S(e) {
       ...
       if (t.enabled && (!t.animating || !s.preventInteractionOnTransition)) {
        ...
        if (
         ...
         ((n.isTouchEvent = "touchstart" === u.type), (n.isTouchEvent || !("which" in u) || 3 !== u.which) && !(!n.isTouchEvent && "button" in u && u.button > 0) && (!n.isTouched || !n.isMoved))
        ) {
         !!s.noSwipingClass && "" !== s.noSwipingClass && u.target && u.target.shadowRoot && e.path && e.path[0] && (c = (0, o.Z)(e.path[0]));
         ...
         if (
          ...
          (f
           ? (function (e, t) {
              return (
               void 0 === t && (t = this),
               (function t(r) {
                return r && r !== (0, a.Me)() && r !== (0, a.Jj)() ? (r.assignedSlot && (r = r.assignedSlot), r.closest(e) || t(r.getRootNode().host)) : null;
               })(t)
              );
             })(p, u.target)
           : c.closest(p)[0])
          ...
          if (m && (v <= g || v >= i.innerWidth - g)) {
           if ("prevent" !== m) return;
           e.preventDefault();
          }
          if (
           ((0, l.l7)(n, { isTouched: !0, isMoved: !1, allowTouchCallbacks: !0, isScrolling: void 0, startMoving: void 0 }),
           (d.startX = v),
           (d.startY = h),
           ...
           var w = !0;
           c.is(n.focusableElements) && (w = !1), r.activeElement && (0, o.Z)(r.activeElement).is(n.focusableElements) && r.activeElement !== c[0] && r.activeElement.blur();
           var b = w && t.allowTouchMove && s.touchStartPreventDefault;
           (!s.touchStartForcePreventDefault && !b) || c[0].isContentEditable || u.preventDefault();
          }
          t.emit("touchStart", u);
         }
        }
       ...
       if (r.enabled) {
        ...
        if ((u.originalEvent && (u = u.originalEvent), i.isTouched)) {
         if (!i.isTouchEvent || "touchmove" === u.type) {
          ...
          if (!r.allowTouchMove) return (r.allowClick = !1), void (i.isTouched && ((0, l.l7)(s, { startX: p, startY: f, currentX: p, currentY: f }), (i.touchStartTime = (0, l.zO)())));
          ...
          if (i.isTouchEvent && t.activeElement && u.target === t.activeElement && (0, o.Z)(u.target).is(i.focusableElements)) return (i.isMoved = !0), void (r.allowClick = !1);
          if ((i.allowTouchCallbacks && r.emit("touchMove", u), !(u.targetTouches && u.targetTouches.length > 1))) {
           ...
           if (!(r.params.threshold && Math.sqrt(Math.pow(v, 2) + Math.pow(h, 2)) < r.params.threshold)) {
            ...
            if ("undefined" === typeof i.isScrolling)
             (r.isHorizontal() && s.currentY === s.startY) || (r.isVertical() && s.currentX === s.startX)
              ? (i.isScrolling = !1)
              : v * v + h * h >= 25 && ((m = (180 * Math.atan2(Math.abs(h), Math.abs(v))) / Math.PI), (i.isScrolling = r.isHorizontal() ? m > n.touchAngle : 90 - m > n.touchAngle));
            if ((i.isScrolling && r.emit("touchMoveOpposite", u), "undefined" === typeof i.startMoving && ((s.currentX === s.startX && s.currentY === s.startY) || (i.startMoving = !0)), i.isScrolling)) i.isTouched = !1;
             ...
             (s.diff = g), (g *= n.touchRatio), d && (g = -g), (r.swipeDirection = g > 0 ? "prev" : "next"), (i.currentTranslate = g + i.startTranslate);
             var w = !0,
              b = n.resistanceRatio;
             if (
              (n.touchReleaseOnEdges && (b = 0),
              g > 0 && i.currentTranslate > r.minTranslate()
               ? ((w = !1), n.resistance && (i.currentTranslate = r.minTranslate() - 1 + Math.pow(-r.minTranslate() + i.startTranslate + g, b)))
               : g < 0 && i.currentTranslate < r.maxTranslate() && ((w = !1), n.resistance && (i.currentTranslate = r.maxTranslate() + 1 - Math.pow(r.maxTranslate() - i.startTranslate - g, b))),
             ...
             n.followFinger &&
              !n.cssMode &&
              ((n.freeMode || n.watchSlidesProgress || n.watchSlidesVisibility) && (r.updateActiveIndex(), r.updateSlidesClasses()),
              n.freeMode &&
               (0 === i.velocities.length && i.velocities.push({ position: s[r.isHorizontal() ? "startX" : "startY"], time: i.touchStartTime }),
               i.velocities.push({ position: s[r.isHorizontal() ? "currentX" : "currentY"], time: (0, l.zO)() })),
        ...
        } else i.startMoving && i.isScrolling && r.emit("touchMoveOpposite", u);
       }
      }
      function E(e) {
       var t = this,
       ...
       if (t.enabled) {
        var u = e;
        if ((u.originalEvent && (u = u.originalEvent), r.allowTouchCallbacks && t.emit("touchEnd", u), (r.allowTouchCallbacks = !1), !r.isTouched))
        ...
        if (
         (t.allowClick && (t.updateClickedSlide(u), t.emit("tap click", u), f < 300 && p - r.lastClickTime < 300 && t.emit("doubleTap doubleClick", u)),
         (r.lastClickTime = (0, l.zO)()),
         (0, l.Y3)(function () {
          t.destroyed || (t.allowClick = !0);
         }),
         !r.isTouched || !r.isMoved || !t.swipeDirection || 0 === n.diff || r.currentTranslate === r.startTranslate)
        )
        ...
        if (((r.isTouched = !1), (r.isMoved = !1), (r.startMoving = !1), (c = i.followFinger ? (s ? t.translate : -t.translate) : -r.currentTranslate), !i.cssMode))
         if (i.freeMode) {
          ...
          if (i.freeModeMomentum) {
           if (r.velocities.length > 1) {
            var v = r.velocities.pop(),
             ...
             g = v.time - h.time;
            (t.velocity = m / g), (t.velocity /= 2), Math.abs(t.velocity) < i.freeModeMinimumVelocity && (t.velocity = 0), (g > 150 || (0, l.zO)() - v.time > 300) && (t.velocity = 0);
           } else t.velocity = 0;
           ...
           if (y < t.maxTranslate())
            i.freeModeMomentumBounce ? (y + t.maxTranslate() < -C && (y = t.maxTranslate() - C), (S = t.maxTranslate()), (E = !0), (r.allowMomentumBounce = !0)) : (y = t.maxTranslate()), i.loop && i.centeredSlides && (T = !0);
           else if (y > t.minTranslate())
            i.freeModeMomentumBounce ? (y - t.minTranslate() > C && (y = t.minTranslate() + C), (S = t.minTranslate()), (E = !0), (r.allowMomentumBounce = !0)) : (y = t.minTranslate()), i.loop && i.centeredSlides && (T = !0);
            ...
            y = -(y = Math.abs(d[x] - y) < Math.abs(d[x - 1] - y) || "next" === t.swipeDirection ? d[x] : d[x - 1]);
           }
           if (
            (T &&
            ...
            if (((w = s ? Math.abs((-y - t.translate) / t.velocity) : Math.abs((y - t.translate) / t.velocity)), i.freeModeSticky)) {
             var P = Math.abs((s ? -y : y) - t.translate),
              k = t.slidesSizesGrid[t.activeIndex];
             w = P < k ? i.speed : P < 2 * k ? 1.5 * i.speed : 2.5 * i.speed;
            }
          ...
          for (var O = 0, L = t.slidesSizesGrid[0], z = 0; z < o.length; z += z < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup) {
           var _ = z < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
           "undefined" !== typeof o[z + _] ? c >= o[z] && c < o[z + _] && ((O = z), (L = o[z + _] - o[z])) : c >= o[z] && ((O = z), (L = o[o.length - 1] - o[o.length - 2]));
          }
          var A = (c - o[O]) / L,
           I = O < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
          if (f > i.longSwipesMs) {
           if (!i.longSwipes) return void t.slideTo(t.activeIndex);
           "next" === t.swipeDirection && (A >= i.longSwipesRatio ? t.slideTo(O + I) : t.slideTo(O)), "prev" === t.swipeDirection && (A > 1 - i.longSwipesRatio ? t.slideTo(O + I) : t.slideTo(O));
          } else {
           ...
           t.navigation && (u.target === t.navigation.nextEl || u.target === t.navigation.prevEl)
            ? u.target === t.navigation.nextEl
              ? t.slideTo(O + I)
              : t.slideTo(O)
            : ("next" === t.swipeDirection && t.slideTo(O + I), "prev" === t.swipeDirection && t.slideTo(O));
          }
         }
       }
      }
      ...
      var O = {
       attachEvents: function () {
        var e = this,
         ...
         o = e.device,
         l = e.support;
        (e.onTouchStart = S.bind(e)), (e.onTouchMove = T.bind(e)), (e.onTouchEnd = E.bind(e)), r.cssMode && (e.onScroll = M.bind(e)), (e.onClick = x.bind(e));
        var d = !!r.nested;
        if (!l.touch && l.pointerEvents) n.addEventListener(i.start, e.onTouchStart, !1), t.addEventListener(i.move, e.onTouchMove, d), t.addEventListener(i.end, e.onTouchEnd, !1);
        else {
         if (l.touch) {
          var u = !("touchstart" !== i.start || !l.passiveListener || !r.passiveListeners) && { passive: !0, capture: !1 };
          n.addEventListener(i.start, e.onTouchStart, u),
           n.addEventListener(i.move, e.onTouchMove, l.passiveListener ? { passive: !1, capture: d } : d),
           n.addEventListener(i.end, e.onTouchEnd, u),
           i.cancel && n.addEventListener(i.cancel, e.onTouchEnd, u),
           P || (t.addEventListener("touchstart", k), (P = !0));
         }
         ((r.simulateTouch && !o.ios && !o.android) || (r.simulateTouch && !l.touch && o.ios)) &&
          (n.addEventListener("mousedown", e.onTouchStart, !1), t.addEventListener("mousemove", e.onTouchMove, d), t.addEventListener("mouseup", e.onTouchEnd, !1));
        }
        (r.preventClicks || r.preventClicksPropagation) && n.addEventListener("click", e.onClick, !0),
         r.cssMode && s.addEventListener("scroll", e.onScroll),
         r.updateOnWindowResize ? e.on(o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", C, !0) : e.on("observerUpdate", C, !0);
       },
       detachEvents: function () {
        var e = this,
         ...
         l = e.support,
         d = !!r.nested;
        if (!l.touch && l.pointerEvents) n.removeEventListener(i.start, e.onTouchStart, !1), t.removeEventListener(i.move, e.onTouchMove, d), t.removeEventListener(i.end, e.onTouchEnd, !1);
        else {
         if (l.touch) {
          var u = !("onTouchStart" !== i.start || !l.passiveListener || !r.passiveListeners) && { passive: !0, capture: !1 };
          n.removeEventListener(i.start, e.onTouchStart, u), n.removeEventListener(i.move, e.onTouchMove, d), n.removeEventListener(i.end, e.onTouchEnd, u), i.cancel && n.removeEventListener(i.cancel, e.onTouchEnd, u);
         }
         ((r.simulateTouch && !o.ios && !o.android) || (r.simulateTouch && !l.touch && o.ios)) &&
          (n.removeEventListener("mousedown", e.onTouchStart, !1), t.removeEventListener("mousemove", e.onTouchMove, d), t.removeEventListener("mouseup", e.onTouchEnd, !1));
        }
        (r.preventClicks || r.preventClicksPropagation) && n.removeEventListener("click", e.onClick, !0),
         r.cssMode && s.removeEventListener("scroll", e.onScroll),
         e.off(o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", C);
       },
      };
      var L = {
       addClasses: function () {
      ...
      var A = {
        ...
        manipulation: {
         appendSlide: function (e) {
          var t = this,
           r = t.$wrapperEl,
           i = t.params;
          if ((i.loop && t.loopDestroy(), "object" === typeof e && "length" in e)) for (var n = 0; n < e.length; n += 1) e[n] && r.append(e[n]);
          else r.append(e);
          ...
          if (o && (!o || 0 !== Object.keys(o).length)) {
           ...
           if (d && e.currentBreakpoint !== d) {
            ...
            var c = u || e.originalParams,
             ...
             v = s.enabled;
            p && !f
             ? (a.removeClass(s.containerModifierClass + "multirow " + s.containerModifierClass + "multirow-column"), e.emitContainerClasses())
             : !p &&
               f &&
               (a.addClass(s.containerModifierClass + "multirow"),
               ((c.slidesPerColumnFill && "column" === c.slidesPerColumnFill) || (!c.slidesPerColumnFill && "column" === s.slidesPerColumnFill)) && a.addClass(s.containerModifierClass + "multirow-column"),
               e.emitContainerClasses());
            var h = c.direction && c.direction !== s.direction,
             m = s.loop && (c.slidesPerView !== s.slidesPerView || h);
            h && r && e.changeDirection(), (0, l.l7)(e.params, c);
            var g = e.params.enabled;
            (0, l.l7)(e, { allowTouchMove: e.params.allowTouchMove, allowSlideNext: e.params.allowSlideNext, allowSlidePrev: e.params.allowSlidePrev }),
             v && !g ? e.disable() : !v && g && e.enable(),
             (e.currentBreakpoint = d),
             e.emit("_beforeBreakpoint", c),
             m && r && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - n + e.loopedSlides, 0, !1)),
             e.emit("breakpoint", c);
           }
          }
         },
          ...
          if ((void 0 === t && (t = "window"), e && ("container" !== t || r))) {
           ...
           for (var l = 0; l < o.length; l += 1) {
            var d = o[l],
             u = d.point,
             c = d.value;
            "window" === t ? n.matchMedia("(min-width: " + c + "px)").matches && (i = u) : c <= r.clientWidth && (i = u);
           }
           return i || "max";
          }
         },
        ...
        images: {
         loadImage: function (e, t, r, i, n, s) {
          ...
          (0, o.Z)(e).parent("picture")[0] || (e.complete && n) ? u() : t ? (((l = new d.Image()).onload = u), (l.onerror = u), i && (l.sizes = i), r && (l.srcset = r), t && (l.src = t)) : u();
         },
       ...
       N = (function () {
        function e() {
         ...
         if (
          (1 === n.length && n[0].constructor && "Object" === Object.prototype.toString.call(n[0]).slice(8, -1) ? (r = n[0]) : ((t = n[0]), (r = n[1])),
          r || (r = {}),
          (r = (0, l.l7)({}, r)),
          t && !r.el && (r.el = t),
          r.el && (0, o.Z)(r.el).length > 1)
         ) {
          var a = [];
          return (
           (0, o.Z)(r.el).each(function (t) {
            var i = (0, l.l7)({}, r, { el: t });
            a.push(new e(i));
           }),
           a
         ...
         (p.__swiper__ = !0),
          (p.support = d()),
          (p.device = u({ userAgent: r.userAgent })),
          (p.browser = c()),
          (p.eventsListeners = {}),
         ...
         return (
          p.useParams(f),
          (p.params = (0, l.l7)({}, f, I, r)),
          (p.originalParams = (0, l.l7)({}, p.params)),
          (p.passedParams = (0, l.l7)({}, r)),
          p.params &&
           p.params.on &&
          ...
          (0, l.l7)(p, {
           ...
           touchEvents: (function () {
            ...
            return (
             p.support.pointerEvents && (t = ["pointerdown", "pointermove", "pointerup"]),
             (p.touchEventsTouch = { start: e[0], move: e[1], end: e[2], cancel: e[3] }),
             (p.touchEventsDesktop = { start: t[0], move: t[1], end: t[2] }),
        ...
        return (
         ...
         (n.setProgress = function (e, t) {
          ...
          r.translateTo(n, "undefined" === typeof t ? 0 : t), r.updateActiveIndex(), r.updateSlidesClasses();
         }),
         ...
         (n.slidesPerViewDynamic = function () {
          var e = this,
           ...
           a = 1;
          if (t.centeredSlides) {
           for (var o, l = r[s].swiperSlideSize, d = s + 1; d < r.length; d += 1) r[d] && !o && ((a += 1), (l += r[d].swiperSlideSize) > n && (o = !0));
           for (var u = s - 1; u >= 0; u -= 1) r[u] && !o && ((a += 1), (l += r[u].swiperSlideSize) > n && (o = !0));
          } else for (var c = s + 1; c < r.length; c += 1) i[c] - i[s] < n && (a += 1);
          return a;
         }),
         (n.update = function () {
          var e = this;
          ...
          var i = function () {
           ...
           n = (function () {
            if (e && e.shadowRoot && e.shadowRoot.querySelector) {
             var t = (0, o.Z)(e.shadowRoot.querySelector(i()));
             return (
         ...
         (n.destroy = function (e, t) {
          ...
          return (
           "undefined" === typeof r.params ||
            ...
            !1 !== e && ((r.$el[0].swiper = null), (0, l.cP)(r)),
            (r.destroyed = !0)),
           null
          );
         }),
         ...
         (e.installModule = function (t) {
          ...
          var r = t.name || Object.keys(e.prototype.modules).length + "_" + (0, l.zO)();
      ...
      var l = (0, i.forwardRef)(function (e, t) {
       ...
       (0, s.L)(function () {
        if ((t && (t.current = w.current), w.current && v)) {
         ...
         "swiper-slide" !== y && S("swiper-slide");
        }
       }),
        (0, s.L)(
         function () {
          v && w.current && S(v.getSlideClasses(w.current));
         },
         [v]
        ),
        "function" === typeof c &&
       ...
       return i.createElement(
        u,
        o({ ref: w, className: (0, n.kI)(y + (f ? " " + f : "")), "data-swiper-slide-index": m }, g),
        h ? i.createElement("div", { className: "swiper-zoom-container", "data-swiper-zoom": "number" === typeof h ? h : void 0 }, E()) : E()
       );
      });
     ...
     3952: function (e, t, r) {
      ...
      function o(e, t) {
       ...
       if (t.breakpoints) {
        var i = n.Z.prototype.getBreakpoint(t.breakpoints),
      ...
      function u(e) {
       var t,
        ...
        y = o.virtual,
        S = o.thumbs;
       u.includes("thumbs") && d.thumbs && d.thumbs.swiper && m.thumbs && !m.thumbs.swiper && (t = !0),
        u.includes("controller") && d.controller && d.controller.control && m.controller && !m.controller.control && (r = !0),
        u.includes("pagination") && d.pagination && (d.pagination.el || v) && (m.pagination || !1 === m.pagination) && g && !g.el && (i = !0),
        u.includes("scrollbar") && d.scrollbar && (d.scrollbar.el || f) && (m.scrollbar || !1 === m.scrollbar) && b && !b.el && (n = !0),
        u.includes("navigation") && d.navigation && (d.navigation.prevEl || p) && (d.navigation.nextEl || c) && (m.navigation || !1 === m.navigation) && w && !w.prevEl && !w.nextEl && (a = !0);
       (h.forEach(function (e) {
        if ((0, s.Kn)(m[e]) && (0, s.Kn)(d[e])) (0, s.l7)(m[e], d[e]);
        else {
         var t = d[e];
         (!0 !== t && !1 !== t) || ("navigation" !== e && "pagination" !== e && "scrollbar" !== e)
          ? (m[e] = d[e])
          : !1 === t && o[(r = e)] && (o[r].destroy(), "navigation" === r ? ((m[r].prevEl = void 0), (m[r].nextEl = void 0), (o[r].prevEl = void 0), (o[r].nextEl = void 0)) : ((m[r].el = void 0), (o[r].el = void 0)));
        }
        var r;
       }),
       u.includes("children") && y && m.virtual.enabled ? ((y.slides = l), y.update(!0)) : u.includes("children") && o.lazy && o.params.lazy.enabled && o.lazy.load(),
       t) &&
        S.init() &&
        S.update(!0);
       r && (o.controller.control = m.controller.control),
        i && (v && (m.pagination.el = v), g.init(), g.render(), g.update()),
        n && (f && (m.scrollbar.el = f), b.init(), b.updateSize(), b.setTranslate()),
        a && (c && (m.navigation.nextEl = c), p && (m.navigation.prevEl = p), w.init(), w.update()),
      ...
      var v = (0, i.forwardRef)(function (e, t) {
       var r = void 0 === e ? {} : e,
        ...
        S = !1,
        T = (0, i.useState)("swiper-container"),
        E = T[0],
        C = T[1],
        x = (0, i.useState)(null),
        M = x[0],
        ...
        R = (function (e) {
         ...
         var t = { on: {} },
          r = {},
          i = {};
         (0, s.l7)(t, n.Z.defaults), (0, s.l7)(t, n.Z.extendedDefaults), (t._emitClasses = !0), (t.init = !1);
         var o = {},
          l = a.map(function (e) {
           return e.replace(/_/, "");
          });
         return (
          Object.keys(e).forEach(function (n) {
           l.indexOf(n) >= 0
            ? (0, s.Kn)(e[n])
              ? ((t[n] = {}), (i[n] = {}), (0, s.l7)(t[n], e[n]), (0, s.l7)(i[n], e[n]))
              : ((t[n] = e[n]), (i[n] = e[n]))
          ...
          { params: t, passedParams: i, rest: o, events: r }
         );
        })(y),
        V = R.params,
        H = R.passedParams,
       ...
       if (
        ...
        !_.current &&
         ...
         V.loop && (A.current.loopedSlides = o(Y, V)),
         A.current.virtual && A.current.params.virtual.enabled))
       ) {
        A.current.virtual.slides = Y;
        var Z = { cache: !1, renderExternal: P, renderExternalUpdate: !1 };
        (0, s.l7)(A.current.params.virtual, Z), (0, s.l7)(A.current.originalParams.virtual, Z);
       }
       ...
       return (
        ...
        (0, i.useEffect)(function () {
         !z.current && A.current && (A.current.emitSlidesClasses(), (z.current = !0));
        }),
        (0, c.L)(function () {
          ...
          return (
           (function (e, t) {
            var r = e.el,
             ...
             o = e.scrollbarEl,
             l = e.swiper;
            (0, s.d7)(t) && i && n && ((l.params.navigation.nextEl = i), (l.originalParams.navigation.nextEl = i), (l.params.navigation.prevEl = n), (l.originalParams.navigation.prevEl = n)),
             (0, s.fw)(t) && a && ((l.params.pagination.el = a), (l.originalParams.pagination.el = a)),
             (0, s.XE)(t) && o && ((l.params.scrollbar.el = o), (l.originalParams.scrollbar.el = o)),
             l.init(r);
           })({ el: _.current, nextEl: D.current, prevEl: j.current, paginationEl: G.current, scrollbarEl: B.current, swiper: A.current }, V),
           b && b(A.current),
           function () {
        ...
        (0, c.L)(function () {
         ...
         })(H, I.current, Y, N.current);
         return (
          (I.current = H),
          (N.current = Y),
          e.length && A.current && !A.current.destroyed && u({ swiper: A.current, slides: Y, passedParams: H, changedParams: e, nextEl: D.current, prevEl: j.current, scrollbarEl: B.current, paginationEl: G.current }),
          function () {
           W &&
            A.current &&
            Object.keys(W).forEach(function (e) {
        ...
        i.createElement(
         h,
         f({ ref: _, className: (0, s.kI)(E + (l ? " " + l : "")) }, F),
         X["container-start"],
         (0, s.d7)(V) && i.createElement(i.Fragment, null, i.createElement("div", { ref: j, className: "swiper-button-prev" }), i.createElement("div", { ref: D, className: "swiper-button-next" })),
         (0, s.XE)(V) && i.createElement("div", { ref: B, className: "swiper-scrollbar" }),
         (0, s.fw)(V) && i.createElement("div", { ref: G, className: "swiper-pagination" }),
         i.createElement(
          g,
          ...
          V.virtual
           ? (function (e, t, r) {
              var n;
              if (!r) return null;
              var s = e.isHorizontal() ? (((n = {})[e.rtlTranslate ? "right" : "left"] = r.offset + "px"), n) : { top: r.offset + "px" };
              return t
               .filter(function (e, t) {
                return t >= r.from && t <= r.to;
               })
               .map(function (t) {
                return i.cloneElement(t, { swiper: e, style: s });
               });
             })(A.current, Y, M)
           : !V.loop || (A.current && A.current.destroyed)
           ? Y.map(function (e) {
              return i.cloneElement(e, { swiper: A.current });
             })
           : (function (e, t, r) {
              var n = t.map(function (t, r) {
               return i.cloneElement(t, { swiper: e, "data-swiper-slide-index": r });
              });
              function s(e, t, n) {
               return i.cloneElement(e, { key: e.key + "-duplicate-" + t + "-" + n, className: (e.props.className || "") + " " + r.slideDuplicateClass });
              }
              if (r.loopFillGroupWithBlank) {
               var a = r.slidesPerGroup - (n.length % r.slidesPerGroup);
               if (a !== r.slidesPerGroup)
                for (var l = 0; l < a; l += 1) {
                 var d = i.createElement("div", { className: r.slideClass + " " + r.slideBlankClass });
                 n.push(d);
                }
              }
              "auto" !== r.slidesPerView || r.loopedSlides || (r.loopedSlides = n.length);
              ...
              return (
               n.forEach(function (e, t) {
                t < u && p.push(s(e, t, "prepend")), t < n.length && t >= n.length - u && c.push(s(e, t, "append"));
               }),
               e && (e.loopedSlides = u),
               [].concat(c, n, p)
              );
     ...
     6184: function (e, t, r) {
      ...
      function n(e, t) {
       ...
       Object.keys(t)
        ...
        .forEach(function (r) {
         "undefined" === typeof e[r] ? (e[r] = t[r]) : i(t[r]) && i(e[r]) && Object.keys(t[r]).length > 0 ? (t[r].__swiper__ ? (e[r] = t[r]) : n(e[r], t[r])) : (e[r] = t[r]);
        });
      }
      function s(e) {
      ...
      var h = {
       ...
       on: function () {
        ...
        function o(e) {
         ...
         if (t) {
          ...
          else for (var i = p(t).parents(), a = 0; a < i.length; a += 1) p(i[a]).is(n) && s.apply(i[a], r);
         }
        }
        function l(e) {
          ...
          if ((!n && c.dom7Listeners ? (p = c.dom7Listeners[d]) : n && c.dom7LiveListeners && (p = c.dom7LiveListeners[d]), p && p.length))
           for (var f = p.length - 1; f >= 0; f -= 1) {
            ...
            (s && v.listener === s) || (s && v.listener && v.listener.dom7proxy && v.listener.dom7proxy === s)
             ? (c.removeEventListener(d, v.proxyListener, a), p.splice(f, 1))
             : s || (c.removeEventListener(d, v.proxyListener, a), p.splice(f, 1));
           }
         }
        return this;
       },
       ...
       is: function (e) {
        ...
        if ("string" === typeof e) {
         ...
         for (t = p(e), r = 0; r < t.length; r += 1) if (t[r] === a) return !0;
         return !1;
        }
        if (e === s) return a === s;
        if (e === n) return a === n;
       ...
       append: function () {
        for (var e, t = (0, i.Me)(), r = 0; r < arguments.length; r += 1) {
         ...
         for (var n = 0; n < this.length; n += 1)
          ...
          } else if (e instanceof d) for (var a = 0; a < e.length; a += 1) this[n].appendChild(e[a]);
       ...
       prepend: function (e) {
        ...
        for (t = 0; t < this.length; t += 1)
         ...
         } else if (e instanceof d) for (r = 0; r < e.length; r += 1) this[t].insertBefore(e[r], this[t].childNodes[0]);
       ...
       parents: function (e) {
        for (var t = [], r = 0; r < this.length; r += 1) for (var i = this[r].parentNode; i; ) e ? p(i).is(e) && t.push(i) : t.push(i), (i = i.parentNode);
        return p(t);
       },
       closest: function (e) {
        var t = this;
       ...
       find: function (e) {
        for (var t = [], r = 0; r < this.length; r += 1) for (var i = this[r].querySelectorAll(e), n = 0; n < i.length; n += 1) t.push(i[n]);
        return p(t);
       },
       children: function (e) {
        for (var t = [], r = 0; r < this.length; r += 1) for (var i = this[r].children, n = 0; n < i.length; n += 1) (e && !p(i[n]).is(e)) || t.push(i[n]);
        return p(t);
       },
       filter: function (e) {
        return p(c(this, e));
      ...
      function o(e, t) {
       ...
       return (
        a.WebKitCSSMatrix
         ...
         : (r = (s = o.MozTransform || o.OTransform || o.MsTransform || o.msTransform || o.transform || o.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(",")),
       ...
       for (var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = ["__proto__", "constructor", "prototype"], r = 1; r < arguments.length; r += 1) {
        ...
        if (void 0 !== i && null !== i && !d(i))
         for (
          ...
          void 0 !== c && c.enumerable && (l(e[o]) && l(i[o]) ? (i[o].__swiper__ ? (e[o] = i[o]) : u(e[o], i[o])) : !l(e[o]) && l(i[o]) ? ((e[o] = {}), i[o].__swiper__ ? (e[o] = i[o]) : u(e[o], i[o])) : (e[o] = i[o]));
         }
       }
       return e;
      }
        ...
        r &&
         Object.keys(n).forEach(function (r) {
          if (!t[r] && !0 === t.auto) {
           ...
           (i.className = n[r]), e.append(i), (t[r] = i);
          }
         }),
        t
       );
