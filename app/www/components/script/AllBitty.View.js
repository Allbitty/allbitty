...
AllBitty.ID_CONSTANT = 'fir-';

AllBitty.prototype.initTemplates = function() {
  this.templates = {};
...
AllBitty.prototype.viewHome = function() {
  this.getAllRestaurants();
};

AllBitty.prototype.viewList = function(filters, filter_description) {
...
AllBitty.prototype.viewSetup = function() {
  var headerEl = this.renderTemplate('header-base', {
...
AllBitty.prototype.initReviewDialog = function() {
...
AllBitty.prototype.initFilterDialog = function() {
...
AllBitty.prototype.updateQuery = function(filters) {
...
AllBitty.prototype.viewRestaurant = function(id) {
  var sectionHeaderEl;
  var that = this;
...
AllBitty.prototype.renderTemplate = function(id, data) {
...
AllBitty.prototype.render = function(el, data) {
  if (!data) {
    return;
  }
...
AllBitty.prototype.useModifier = function(el, selector, modifier) {
  el.querySelectorAll('[' + selector + ']').forEach(modifier);
};

AllBitty.prototype.getDeepItem = function(obj, path) {
...
AllBitty.prototype.renderRating = function(rating) {
...
AllBitty.prototype.renderPrice = function(price) {
...
AllBitty.prototype.replaceElement = function(parent, content) {
  parent.innerHTML = '';
  parent.append(content);
};

AllBitty.prototype.rerender = function() {
